...
bitnami-mampstack-7.1.18-1-osx-x86-installer.dmg 
...
a regular user, or /opt/mampstack-7.1.18-1, if you are running the 
...
/Applications/mampstack-7.1.18-1 and that you use port 8080 for Apache and 3306 for MySQL.
