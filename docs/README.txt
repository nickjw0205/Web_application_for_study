...
/Applications/mampstack-7.1.18-1/apache2/htdocs
...
You should copy the "demo" folder into the /Applications/mampstack-7.1.18-1/apps 
folder and add the following line at the end of the
/Applications/mampstack-7.1.18-1/apache2/conf/bitnami/bitnami-apps-prefix.conf

Include "/Applications/mampstack-7.1.18-1/apps/demo/conf/httpd-prefix.conf"
...
configuration in the "/Applications/mampstack-7.1.18-1/apache2/conf/bitnami/bitnami-apps-prefix.conf" file

#Include "/Applications/mampstack-7.1.18-1/apps/demo/conf/httpd-prefix.conf"

and enable the new Virtual Host configuration file in the 
"/Applications/mampstack-7.1.18-1/apache2/conf/bitnami/bitnami-apps-vhosts.conf" file:

Include "/Applications/mampstack-7.1.18-1/apps/demo/conf/httpd-vhosts.conf"
