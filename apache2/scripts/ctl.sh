...
HTTPD_PIDFILE=/Applications/mampstack-7.1.18-1/apache2/logs/httpd.pid


HTTPD="/Applications/mampstack-7.1.18-1/apache2/bin/httpd -f /Applications/mampstack-7.1.18-1/apache2/conf/httpd.conf"
...
. /Applications/mampstack-7.1.18-1/apache2/bin/envvars
