...
MYSQL_PIDFILE=/Applications/mampstack-7.1.18-1/mysql/data/mysqld.pid

MYSQL_START="/Applications/mampstack-7.1.18-1/mysql/bin/mysqld_safe --defaults-file=/Applications/mampstack-7.1.18-1/mysql/my.cnf --mysqld=mysqld.bin --socket=/Applications/mampstack-7.1.18-1/mysql/tmp/mysql.sock  --datadir=/Applications/mampstack-7.1.18-1/mysql/data --log-error=/Applications/mampstack-7.1.18-1/mysql/data/mysqld.log  --pid-file=$MYSQL_PIDFILE --lower-case-table-names=1 "
