...
if ('/Applications/mampstack-7.1.18-1/php/lib/php ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/Applications/mampstack-7.1.18-1/php/lib/php '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
